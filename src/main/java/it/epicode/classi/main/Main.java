...
public class Main {
    public static void main(String[] args) {
        ...
        Partecipazione partecipazione4 = new Partecipazione(persona5, Stato.CONFERMATO, evento4);
        ...
        Partecipazione partecipazione8 = new Partecipazione(persona9, Stato.CONFERMATO, evento4);
        ...
        Partecipazione partecipazione13 = new Partecipazione(persona4, Stato.CONFERMATO, evento1);
        ...
        Partecipazione partecipazione19 = new Partecipazione(persona10, Stato.CONFERMATO, evento3);
        Partecipazione partecipazione20 = new Partecipazione(persona1, Stato.CONFERMATO, evento4);
        Partecipazione partecipazione21 = new Partecipazione(persona2, Stato.CONFERMATO, evento1);
